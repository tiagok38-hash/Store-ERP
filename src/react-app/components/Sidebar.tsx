...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'admin-parameters', label: 'Termos de Compra e Impressão', icon: Printer, path: '/administration/system-parameters', permission: UserPermissions.SETTINGS_VIEW },
      ...
      { id: 'admin-product-structure', label: 'Marcas, Categorias e Variações', icon: Package, path: '/administration/product-structure', permission: UserPermissions.SECTION_BRANDS_CATEGORIES },
