    ...
    <div className="p-6 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Total de Logs</h3>
          <p className="text-3xl font-bold text-slate-600">{auditLogs.length}</p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Criações</h3>
          <p className="text-3xl font-bold text-green-600">{auditLogs.filter(l => l.action === 'CREATE').length}</p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Edições</h3>
          <p className="text-3xl font-bold text-blue-600">{auditLogs.filter(l => l.action === 'UPDATE').length}</p>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Exclusões</h3>
          ...
          <table className="w-full">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-semibold text-slate-700">Tabela</th>
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <div className="text-xs text-slate-600">ID: {log.userId}</div>
                      </div>
                    </div>
                  </td>
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm">{getTableLabel(selectedLog.tableName)}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">ID do Registro</label>
              ...
              {selectedLog.oldValues && (
                <div className="mb-4">
                  <label className="block text-sm font-medium text-slate-700 mb-2">Valores Anteriores</label>
              ...
              {selectedLog.newValues && (
                <div className="mb-4">
                  <label className="block text-sm font-medium text-slate-700 mb-2">Novos Valores</label>
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 break-all">{selectedLog.userAgent}</p>
              </div>
            </div>
          </div>
        </div>
