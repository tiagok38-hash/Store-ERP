    ...
    <div className="p-6 bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-slate-600">Estrutura hierárquica dos produtos</p>
        </div>
      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <h4 className="font-medium text-slate-800">{brand.name}</h4>
                      {brand.description && (
              ...
              {selectedCategory ? (
                filteredSubcategories.map((subcategory) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h4 className="font-medium text-slate-800">{subcategory.name}</h4>
          ...
          <div className="p-4">
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                disabled={!selectedSubcategory}
              />
            </div>
            <div className="space-y-2 max-h-96 overflow-y-auto">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        {variation.description && (
                          <p className="text-xs text-slate-600 mt-1">{variation.description}</p>
                        )}
                      </div>
                      <div className="flex gap-1">
                        <button
