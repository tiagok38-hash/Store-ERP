          ...
          <table className="w-full">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-semibold text-slate-700">Perfil</th>
                <th className="text-left py-3 px-4 font-semibold text-slate-700">Contato</th>
                <th className="text-left py-3 px-4 font-semibold text-slate-700">Último Acesso</th>
                  ...
                  <div className="max-h-96 overflow-y-auto border border-slate-200 rounded-lg p-4">
                    {permissionGroups.map(group => (
                      <div key={group.name} className="mb-4">
                        <h4 className="font-medium text-slate-700 mb-2">{group.name}</h4>
                        <div className="space-y-2">
                          {group.permissions.map(permission => (
                            <label key={permission.key} className="flex items-center">
                              ...
                              />
                              <span className="ml-2 text-sm text-slate-600">{permission.label}</span>
                            </label>
                          ))}
                        </div>
                      </div>
